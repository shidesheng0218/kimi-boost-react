...
**React + TypeScript 最佳实践:组件组合、Hooks 规范、性能与可访问性。**
...
```
/plugins install https://github.com/shidesheng0218/kimi-boost-react
```
...
本仓库是 [kimi-boost](https://github.com/shidesheng0218/kimi-boost) monorepo 的**只读镜像**，由 CI 从 `presets/react/` 自动同步，请勿直接提 PR；贡献请到主仓库。MIT License。
